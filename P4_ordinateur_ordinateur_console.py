...
########################################################################
#
#  Puissance 4 - Ordinateur contre Ordinateur avec IA (mode Console)
#
#  Copyright 2016-2019 - Eric Sérandour
#  Version du 06 octobre 2019 à 19 h 46
#
...
NB_PARTIES = 1000  # A adapter (un nombre pair plus grand que 1)
IA_JAUNE = 9  # Numéro de l'IA en compétition (entre 0 et 9 actuellement)
IA_ROUGE = 6  # Numéro de l'IA en compétition (entre 0 et 9 actuellement)
...
def fin_partie():
    ...
    if alignements(4, couleur):
        ...
        #affiche_joueur_console()                                            # Affichage Joueur
    return fin
...
def jouer(colonne):
    ...
    #affiche_grille_console()                                                 # Affichage Grille
